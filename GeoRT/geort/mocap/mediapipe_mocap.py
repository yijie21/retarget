...
import cv2
# Note: RealSenseCamera (and its pyrealsense2 dependency) is imported lazily inside
# MediaPipeMocap.__init__ so that webcam-only setups don't need pyrealsense2 installed.
...
class MediaPipeMocap:
    def __init__(self):
        from geort.mocap.camera.realsense import RealSenseCamera  # lazy: needs pyrealsense2
