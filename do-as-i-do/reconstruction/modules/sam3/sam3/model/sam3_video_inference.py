...
class Sam3VideoInference(Sam3VideoBase):
    ...
    def _build_tracker_output(
        ...
        # When adding the first point prompt before any propagation, the cache
        # may not yet contain this frame.  Fall back to an empty dict so that
        # only the newly refined masks are returned.
