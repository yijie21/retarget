...
from scripts.scripts_test_video.detect_track_video import resolve_paths
...
def hawor_motion_estimation(args, start_idx, end_idx, seq_folder):
    ...
    _, img_folder = resolve_paths(args.video_path)
    ...
    print(f'Running hawor on {seq_folder} ...')
...
def hawor_infiller(args, start_idx, end_idx, frame_chunks_all, static_camera=False):
    # load infiller
