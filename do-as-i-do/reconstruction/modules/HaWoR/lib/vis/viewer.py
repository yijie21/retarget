...
# Monkey-patch moderngl_window headless to use EGL backend by default
import moderngl_window.context.headless.window as _headless_window
_original_init = _headless_window.Window.__init__
def _egl_init(self, **kwargs):
    kwargs.setdefault('backend', 'egl')
    _original_init(self, **kwargs)
_headless_window.Window.__init__ = _egl_init
